...
(function () {
  const TECH = {
    frontend: [
      ...
      ['CSS', 'css'], ['Vite', 'vite'], ['ESLint', 'eslint'], ['Prettier', 'prettier'],
    ],
    backend: [
    ...
    devops: [
      ['AWS', 'amazonaws'], ['Azure', 'microsoftazure'], ['GitHub Actions', 'githubactions'], ['Jenkins', 'jenkins'],
      ['GitLab CI', 'gitlab'], ['Docker', 'docker'], ['Kubernetes', 'kubernetes'], ['Datadog', 'datadog'], ['Vercel', 'vercel'],
    ],
    ai: [
    ...
    devtools: [
      ['Git', 'git'], ['GitHub', 'github'], ['GitLab', 'gitlab'], ['Bitbucket', 'bitbucket'], ['VS Code', 'visualstudiocode'],
      ...
      ['JIRA', 'jira'], ['Notion', 'notion'], ['Cisco Packet Tracer', 'cisco'],
    ],
  };
...
(function () {
  ...
  const commands = {
    ...
    whoami: () => 'judea_ann_tablate — BSCS (Software Engineering), FEU Institute of Technology. Aspiring AI & ML Engineer / Cloud Engineer.',
